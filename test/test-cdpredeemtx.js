...
5, scoinsToRedeem: the number of redemptions
6, collateralRatio: mortgage ratio
7, scoinsInterest: interest
*/
/*
构建cdp赎回的交易
注意：
...
4、cdpTxId:cdp交易hash
5、scoinsToRedeem:赎回的数量
6、collateralRatio:抵押比率
7、scoinsInterest:利息
*/
var cdpRedeemTxinfo = {
    ...
    scoinsToRedeem: 2000000000000,
    collateralRatio: 7000000,
    scoinsInterest: 7000000,
    network: 'testnet'
  };
