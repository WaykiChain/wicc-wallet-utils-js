...
var CdpRedeemTx = function CdpRedeemTx(arg) {
    ...
    this.bcoins_to_redeem = info.bcoins_to_redeem;
  ...
  CdpRedeemTx._fromObject = function _fromObject(data) {
    ...
    var info = {
      ...
      bcoins_to_redeem: data.bcoins_to_redeem,
  ...
  CdpRedeemTx.prototype._SignatureHash = function() {
    ...
    if(this.cdpTxId==null) return false
     ...
     if(! /^[1-9]*[1-9][0-9]*$/.test(this.scoins_to_repay))
      return false;
     var scoins_to_repayBuf = Util.writeVarInt(8, this.scoins_to_repay)
    writer.write(scoins_to_repayBuf)

    if(! /^[1-9]*[1-9][0-9]*$/.test(this.bcoins_to_redeem))
    return false;
    var bcoins_to_redeemBuf = Util.writeVarInt(8, this.bcoins_to_redeem)
    writer.write(bcoins_to_redeemBuf)
  ...
  CdpRedeemTx.prototype.SerializeTx = function(privateKey) {
   ...
   if(! /^[0-9]*[0-9][0-9]*$/.test(this.bcoins_to_redeem))
    return false;
    var bcoins_to_redeemBuf = Util.writeVarInt(8, this.bcoins_to_redeem)
    writer.write(bcoins_to_redeemBuf)
